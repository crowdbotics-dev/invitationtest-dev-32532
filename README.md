...
## Project Structure
    ...
    ├── invitationtest_dev_32532  # Django project configurations
...
1. Clone this repo and `cd invitationtest_dev_32532`
...
2. Clone this repo and `cd invitationtest_dev_32532`
